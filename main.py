pyrogram.errors.exceptions.bad_request_400 import StickerEmojiInvalid
import requests
import json
import subprocess
...
bot = Client("bot",
             bot_token= "6728485784:AAFHgTLL28oqvKWaO_ObX3a3oFIWruT_x54",
             api_id= 25298674,
